...
# --- MCQ ANALYSIS BLOCK ---
print("\n" + "="*30)
print("PART 1 & 2 ANALYSIS")
print("="*30)
# Count nodes in each of the 3 clusters
print("NODES PER CLUSTER:\n", df['Cluster'].value_counts().sort_index())

# Calculate average energy to find the 'weakest' cluster
print("\nAVG ENERGY PER CLUSTER:\n", df.groupby('Cluster')['Energy'].mean())

# Find the specific node with the lowest energy
crit = df.loc[df['Energy'].idxmin()]
print(f"\nCRITICAL NODE: {crit['Node']} | Cluster: {crit['Cluster']} | Energy: {crit['Energy']}")
print("="*30)
input("Review the data above, then press Enter to finish...")
